...
import { Category } from '../data/ingredients';
    ...
    <div className="absolute inset-x-0 bottom-0 h-[40vh] glass border-t border-zinc-800 flex flex-col z-50">
      ...
      <div className="flex-1 min-h-0 relative overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          >
            {activeTab === 'bun' && (
              <BunSection burgerState={burgerState} onChangeSlot={setSlot} />
            )}
            {activeTab === 'protein' && (
              <ProteinSection
            ...
            {activeTab === 'cheese' && (
              <CheeseSection burgerState={burgerState} onChangeSlot={setSlot} />
            )}
            {activeTab === 'topping' && (
              <ToppingSection
                burgerState={burgerState}
            ...
            {activeTab === 'sauce' && (
              <SauceSection burgerState={burgerState} onChangeSlot={setSlot} />
            )}
          </motion.div>
        </AnimatePresence>
      </div>
