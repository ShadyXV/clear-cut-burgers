...
export const PNG_MAP: Record<string, string> = {
  // Bun Bottoms
  brioche_bottom: `${base}images/brioche_bun_bottom.png`,
  sesame_bottom: `${base}images/sesame_bun_bottom.png`,
  paprika_bottom: `${base}images/paprika_bun_bottom.png`,
  cheeseTopped_bottom: `${base}images/brioche_bun_bottom.png`,
  chiveSesame_bottom: `${base}images/sesame_bun_bottom.png`,
  // Bun Tops
  brioche_top: `${base}images/brioche_bun_top.png`,
  sesame_top: `${base}images/sesame_bun_top.png`,
  paprika_top: `${base}images/paprika_bun_top.png`,
  cheeseTopped_top: `${base}images/cheese_topped_bun_top.png`,
  chiveSesame_top: `${base}images/chive_sesame_bun_top.png`,

  beefPatty: `${base}images/beef_patty.png`,
  grilledChicken: `${base}images/grilled_chicken.png`,
  crispyChicken: `${base}images/crispy_chicken.png`,
  blackBeanPatty: `${base}images/black_bean_patty.png`,
  chickpeaPatty: `${base}images/chickpea_patty.png`,
  mushroomPatty: `${base}images/mushroom_patty.png`,

  cheddar: `${base}images/cheddar_cheese.png`,
  emmental: `${base}images/emmental_cheese.png`,
  pepperCheese: `${base}images/pepper_cheese.png`,
  mozzarella: `${base}images/mozzarella_cheese.png`,
  cashewCheese: `${base}images/cashew_cheese.png`,
  veganSmoked: `${base}images/vegan_smoked_cheese.png`,

  tomato: `${base}images/tomato.png`,
  redOnion: `${base}images/red_onion.png`,
  whiteOnion: `${base}images/white_onion.png`,
  friedOnion: `${base}images/fried_onions.png`,
  pickles: `${base}images/pickles.png`,
  bacon: `${base}images/bacon.png`,
  pineapple: `${base}images/pineapple.png`,
  guacamole: `${base}images/guacamole.png`,
  jalapeno: `${base}images/jalapenos.png`,
  peppers: `${base}images/sweet_peppers.png`,

  sauceMayo: `${base}images/pepper_mayo_pool.png`,
  sauceHabanero: `${base}images/habanero_sauce_pool.png`,
  saucePiri: `${base}images/piri_piri_sauce_pool.png`,
};
