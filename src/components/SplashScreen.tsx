  ...
  >
    ...
    <div className="relative flex flex-col items-center text-center px-10 max-w-xs gap-8">
      ...
      <div className="flex items-center gap-2.5">
        <div className="w-7 h-7 bg-amber-500 rounded-lg flex items-center justify-center font-black text-zinc-950 text-xs">B</div>
        <span className="text-[11px] font-bold tracking-[0.22em] text-zinc-500 uppercase">Stack Master Labs</span>
      </div>

      {/* Headline */}
      <div className="flex flex-col gap-1">
        <p className="text-5xl font-black italic text-zinc-100 leading-none tracking-tight">BUILD YOUR</p>
        <p className="text-5xl font-black italic text-amber-500 leading-none tracking-tight">PERFECT STACK.</p>
      </div>

      {/* Subtext */}
      <p className="text-sm text-zinc-500 leading-relaxed">
        Pick your bun. Stack your protein.<br />
